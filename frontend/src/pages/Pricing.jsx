...
import { CheckCircle, Zap, Rocket, ShieldCheck } from "lucide-react"
    ...
    <div className="min-h-screen bg-black pt-24 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20 animate-fade-in">
          <div className="inline-block px-6 py-3 bg-orange-500/20 border border-orange-500/50 rounded-full text-orange-400 font-semibold mb-6">
          ...
          <div className="w-32 h-1 bg-gradient-to-r from-orange-500 to-orange-600 mx-auto mt-6"></div>
        </div>

        {/* ================= FREE TRIAL ================= */}
        <div className="card mb-24 border-orange-500/60 shadow-2xl shadow-orange-500/20 animate-fade-in">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                to="/contact"
                className="inline-block px-10 py-4 rounded-full font-bold bg-gradient-to-r from-orange-500 to-orange-600 text-white hover:scale-105 transition"
              >
                Start Free Trial
              </Link>
            </div>
            ...
            <div className="relative">
              ...
              <Rocket className="relative w-40 h-40 text-orange-500 mx-auto" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full text-sm font-bold flex items-center gap-2">
                ...
                <Link
                  to="/contact"
                  className="block text-center py-4 rounded-full font-bold border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white transition"
                >
                  Talk to Us
                </Link>
              </div>
